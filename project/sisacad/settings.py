"""
Django settings for sisacad project.
...
SECRET_KEY = 'django-insecure-!nvj6==a=7ya$(!*_vj5hry%*8k6*(y+t+9$q_t8*yo6#+#(hw'
...
WSGI_APPLICATION = 'sisacad.wsgi.app'
